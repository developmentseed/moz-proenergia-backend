...
class TestMultiFieldSummaryView(APITestCase):
    def setUp(self):
        ...
        # Create test data
        self.test_data = {
            1: {"cost": 23423, "population": 1500, "location": "Maputo", "technology": "SHS", "district": "Central"},
            2: {"cost": 12334.5, "population": 2300, "location": "Chifunde", "technology": "GridExtension", "district": "Norte"},
            3: {"cost": 230923.7, "population": 45000, "location": "Maputo", "technology": "ExistingGrid", "district": "Central"},
            4: {"cost": 23093, "population": 1200, "location": "Maputo", "technology": "SHS", "district": "Central"},
            5: {"cost": 2523, "population": 800, "location": "Maputo", "technology": "SHS", "district": "Sul"},
            6: {"cost": 63423, "population": 3400, "location": "Maputo", "technology": "GridExtension", "district": "Central"},
            7: {"cost": 93423, "population": 5600, "location": "Tete", "technology": "MiniGrid_PV", "district": "Norte"},
            8: {"cost": 6423, "population": 450, "location": "Mocumba", "technology": "SHS", "district": "Sul"},
            9: {"cost": 13223, "population": 890, "location": "Tete", "technology": "SHS", "district": "Norte"},
            10: {"cost": 898623, "population": 78000, "location": "Tete", "technology": "ExistingGrid", "district": "Norte"},
            11: {"cost": 49730, "population": 2100, "location": "Maputo", "technology": "MiniGrid_PV", "district": "Central"},
        }
    ...
    def test_multiple_filters(self):
        ...
        url = reverse("datasets:scenario-summaries", args=[self.scenario.id])
        res = self.client.get(url, {"fields": "population", "q": "location=Maputo,cost__min=20000"})
