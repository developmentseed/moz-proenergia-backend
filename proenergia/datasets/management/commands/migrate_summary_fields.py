                        ...
                        if model.name == "Least Cost Electrification":
                            ...
                            if column in ["Technology2030", "Status"]:
                                fields_map[column]['type'] = 'string'
                                          ...
                                          "MGInvestmentCostTotal", "MGInvestmentGenTotal",
                                          "MGInvestmentDistTotal", "MGCapacityPV",
                                          "MGCapacityDiesel", "MGCapacityBattery",
                                          "MGCapacityWind", "MGCapacityHydro",
                                          "InstalledCapacity", "ExistingConnections"]:
                                fields_map[column]['type'] = 'numeric'
